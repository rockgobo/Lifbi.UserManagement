...
namespace Christoc.Modules.Lifbi.UserManagement.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.Lifbi.UserManagement.Data.SqlDataprovider,Lifbi.UserManagement";
